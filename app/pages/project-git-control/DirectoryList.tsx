...
import { FaCodePullRequest, FaCheck } from "react-icons/fa6";
        ...
        <div className="directories-list space-y-4">
          {filteredDirectories.length > 0 && filteredDirectories.map((dir, index) => (
            <div
              key={dir.path}
              data-index={index}
              className="directory-item rounded-2xl border border-gray-200 dark:border-gray-700 p-5 shadow-md hover:shadow-lg transition-shadow bg-white dark:bg-gray-900"
            >
